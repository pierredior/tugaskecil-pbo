...
$title = 'Add Supplier - Modern Web Store';
    ...
    if (!isset($_POST['csrf_token']) || !validateCSRFToken($_POST['csrf_token'])) {
        ...
        if (empty($nama_supplier)) {
            ...
            try {
                ...
                $stmt = $pdo->prepare("INSERT INTO supplier (nama_supplier, alamat, telepon, email) VALUES (?, ?, ?, ?)");
                $stmt->execute([$nama_supplier, $alamat, $telepon, $email]);

                // Log the activity
                logActivity('create_supplier', "Created new supplier: $nama_supplier");
                ...
                $error = 'An error occurred while adding the supplier. Please try again.';
            }
        }
    }
}
...
<div class="content p-6">
    <div class="mb-6">
        ...
        <p class="text-base-content/70">Create a new product supplier</p>
    </div>
            ...
            <form method="POST" action="add.php" data-validate>
                ...
                <div class="form-control mb-4">
                    ...
                    <input 
                        ...
                        value="<?php echo isset($_POST['nama_supplier']) ? e($_POST['nama_supplier']) : ''; ?>"
